...
-- Policies for reading properties
...
-- Policies for inserting/updating properties (admin only)
DROP POLICY IF EXISTS "properties_admin_all" ON crexi_properties;
CREATE POLICY "properties_admin_all" ON crexi_properties
    FOR ALL
    USING (
        EXISTS (
...
(
    ...
    -97.7431,
    30.2672,
    'Modern office and industrial complex in prime Austin location',
    CURRENT_DATE
);
*/
